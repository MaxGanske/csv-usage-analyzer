# SQLAlchemy persistence models for report summaries.
# The initial prototype stores aggregate results rather than raw uploaded files.
...
def new_report_id() -> str:
    """Generate the stable string identifier assigned to a new report."""
    return str(uuid4())


def utc_now() -> datetime:
    """Return a timezone-aware UTC timestamp for report creation."""
